...
<html>
	<head>
		...
		<script src="http://code.jquery.com/ui/1.10.3/jquery-ui.js" type="text/javascript"></script>
		<script src="/style/general/2/javascripts/bootstrap.min.js" type="text/javascript"></script>
		<script src="/style/general/2/javascripts/raphael.min.js" type="text/javascript"></script>
		<script src="/style/general/2/javascripts/selectivizr-min.js" type="text/javascript"></script>
		<script src="/style/general/2/javascripts/jquery.mousewheel.js" type="text/javascript"></script>
		<script src="/style/general/2/javascripts/jquery.vmap.min.js" type="text/javascript"></script>
		<script src="/style/general/2/javascripts/jquery.vmap.sampledata.js" type="text/javascript"></script>
		<script src="/style/general/2/javascripts/jquery.vmap.world.js" type="text/javascript"></script>
		...
		<link rel="stylesheet" href="/style/general/2/gen/fa.min.css">
		<script type="text/javascript">
			$(document).ready(function() {
				$("body").css("display", "none");
			});
						...
						<ul class="nav navbar-nav pull-right">
							<li class="dropdown notifications hidden-xs">
								...
								<ul class="dropdown-menu">
									...
									<li><a href="/shops/settings/<?=$get_shop_uved['domain']?>/goods/fill/<?=$value['id']?>/">
